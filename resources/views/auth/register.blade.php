            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="patronym" class="col-md-4 col-form-label text-md-right">{{ __('Отчество') }}</label>

                            <div class="col-md-6">
                                <input id="patronym" type="text" class="form-control @error('patronym') is-invalid @enderror" name="patronym" value="{{ old('patronym') }}"  autocomplete="patronym" autofocus>
